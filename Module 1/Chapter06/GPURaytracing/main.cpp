...
//mesh rendering shader, raytracing shader and flat shader
...
//keyboard event handler to toggle raytracing and rasterization
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("GPU Raytracer - OpenGL 3.3");
